...
4. **テンプレートを選択**（7種類から選択）
   ...
   | テンプレート | 特徴 | ページ数 | リポジトリ |
   |-------------|------|---------|-----------|
   | 標準テンプレート | 企業HP標準テンプレート | 6 | template-standard |
   | フルオーダー | 完全カスタム | 0 | template-fullorder |
   | 採用サイト（マガジン形式） | 採用特化、読ませるエディトリアル | 7 | template-recruit-magazine |
   | リード獲得型（ミニマル） | CV最短ルート、余白とタイポグラフィ | 4 | template-leadgen-minimal |
   | 地域密着型（ビジュアル） | 地域商圏×SEO、写真・動画主役 | 5 | template-leadgen-visual |
   | 信頼構築型（ビジュアル） | 社会的証明の最大化 | 6 | template-trust-visual |
   | 権威性訴求（ミニマル） | 専門性・実績で説得 | 8 | template-authority-minimal |
...
- [ ] 構成案プロンプトが正しく生成されたか
- [ ] 外部AIの出力（構成案）が十分な内容か
- [ ] 適切なテンプレートを選択したか（7種類から企業の特徴に合わせて）
